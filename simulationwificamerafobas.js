...
// ============================================================
// FOBAS WIFI PRACTICAL INTERFACE CONTROLLER
// ============================================================
//
// RÔLE :
// Transforme la sélection d'un réseau Wi-Fi virtuel
// en véritable espace pratique pédagogique.
//
// FLUX :
//
...
// wifi.select_target
//        ↓
// Poste de travail Wi-Fi virtuel
//        ↓
// ANALYZE TARGET
//        ↓
// wifi.analyze_target
...
// - Aucune tentative d'authentification.
// - Aucune connexion à un réseau réel.
// - Aucun mot de passe réel récupéré.
// - Aucune attaque réelle exécutée.
// - Ce bloc contrôle uniquement l'interface pratique.
// - Les moteurs d'action existants restent responsables
//   de leurs propres opérations et validations.
// ============================================================
...
(function(){
    ...
    // ========================================================
    // VERIFICATION DES DEPENDANCES PRINCIPALES
    // ========================================================

    if(!Simulation){

        console.warn(
            "[FOBAS WiFi Practical Interface] " +
            "FOBASCybersecuritySimulation introuvable."
        );
    ...
    // ========================================================
    // RECHERCHE DU CONTENEUR WIFI EXISTANT
    // ========================================================

    function findWiFiContainer(){
        ...
        const selectors = [
            ...
            '[data-laboratory="wifi"]',

            '[data-simulation-lab="wifi"]'
        ];
    ...
    // ========================================================
    // RECHERCHE DES CARTES DE RESEAUX
    // ========================================================

    function findNetworkElements(){
    ...
    // ========================================================
    // EXTRACTION DES DONNEES D'UNE CARTE
    // ========================================================
    ...
    function extractNetworkData(
        ...
        // ----------------------------------------------------
        // RECHERCHE DANS LES ATTRIBUTS STANDARDS
        // ----------------------------------------------------
        ...
        // ----------------------------------------------------
        // SI LE DOM EXISTANT NE FOURNIT PAS LES DONNEES
        // DANS DATASET, ON ESSAIE DE LES EXTRAIRE DU TEXTE.
        // ----------------------------------------------------
    ...
    // ========================================================
    // CREATION DU POSTE DE TRAVAIL
    // ========================================================

    function createPracticalInterface(){

        const existing =
            document.getElementById(
                "fobasWifiPracticalInterface"
            );


        if(existing){

            state.practicalPanel =
                existing;

            state.statusPanel =
                existing.querySelector(
                    "#fobasWifiPracticalStatus"
                );

            state.actionsPanel =
                existing.querySelector(
                    "#fobasWifiPracticalActions"
                );

            state.reportPanel =
                existing.querySelector(
                    "#fobasWifiPracticalReport"
                );
        ...
        panel.innerHTML = `
            ...
            <div
                class="fobas-wifi-practical-header"
            >

                <div>

                    <div
                        class="fobas-wifi-practical-kicker"
                    >
                    ...
                    <p>
                        Environnement pédagogique contrôlé
                        dédié à l'analyse et au renforcement
                        d'une infrastructure Wi-Fi virtuelle.
                    </p>

                </div>

                <div
                    id="fobasWifiPracticalStateBadge"
                    class="fobas-wifi-state-badge"
                >
                    EN ATTENTE
                </div>
            ...
            <div
                id="fobasWifiTargetCard"
                class="fobas-wifi-target-card"
            >

                <div
                    class="fobas-wifi-target-title"
                >
                    Aucune cible sélectionnée
                </div>

                <div
                    class="fobas-wifi-target-grid"
                >

                    <div>
                        <span>SSID</span>
                        <strong data-field="ssid">—</strong>
                    </div>

                    <div>
                        <span>BSSID</span>
                        <strong data-field="bssid">—</strong>
                    </div>

                    <div>
                        <span>Canal</span>
                        <strong data-field="channel">—</strong>
                    </div>

                    <div>
                        <span>Chiffrement</span>
                        <strong data-field="encryption">—</strong>
                    </div>

                    <div>
                        <span>Signal</span>
                        <strong data-field="signal">—</strong>
                    </div>
            ...
            <div
                id="fobasWifiPracticalStatus"
                class="fobas-wifi-practical-status"
            >

                Sélectionnez une cible Wi-Fi virtuelle
            ...
            <div
                class="fobas-wifi-section-title"
            >
            ...
            <div
                id="fobasWifiProgress"
                class="fobas-wifi-progress"
            ></div>
            ...
            <div
                id="fobasWifiPracticalActions"
                class="fobas-wifi-practical-actions"
            ></div>


            <div
                id="fobasWifiPracticalReport"
                class="fobas-wifi-practical-report"
            ></div>
    ...
    function renderTarget(
        ...
        const card =
            state.practicalPanel.querySelector(
                "#fobasWifiTargetCard"
            );
    ...
    function setStatus(
        ...
        if(
            ...
            state.statusPanel.textContent =
                message;

            state.statusPanel.setAttribute(
                "data-status",
                type || "info"
            );
        }
    ...
    function renderActions(){
        ...
        if(!state.selectedTarget){
            ...
            const empty =
                createElement(
                    "div",
                    "fobas-wifi-actions-empty",
                    "Sélectionnez d'abord un réseau Wi-Fi virtuel."
                );


            state.actionsPanel.appendChild(
                empty
            );
    ...
    // ========================================================
    // DETECTION D'UN RESULTAT VALIDE
    // ========================================================
    ...
    function resultMatchesStage(
        ...
        if(
            result.event &&
            (
                result.event.resultState ===
                stage.resultState ||

                result.event.validationKey ===
                stage.validationKey
            )
        ){
    ...
    function moveToNextStage(
        ...
        if(
            ...
            setStatus(
                "Étape validée. " +
                "Vous pouvez maintenant poursuivre avec : " +
                STAGES[
                    state.currentStage
                ].label +
                ".",
            ...
            setStatus(
                "Mission Wi-Fi terminée avec succès. " +
                "Toutes les étapes obligatoires ont été validées.",
                "success"
            );
        }
    ...
    function executeAnalysis(){
        ...
        if(!TargetAnalysis){
            ...
            setStatus(
                "Le moteur d'analyse Wi-Fi est indisponible.",
                "error"
            );
        ...
        if(
            typeof TargetAnalysis.analyzeSelectedTarget !==
            "function"
        ){

            setStatus(
                "L'action d'analyse n'est pas disponible.",
                "error"
            );
        ...
        if(!result){
            ...
            setStatus(
                "L'analyse n'a pas pu être exécutée. " +
                "Vérifiez que la cible est bien sélectionnée.",
                "error"
            );
        ...
        setStatus(
            "L'analyse a été exécutée mais son état " +
            "de validation attendu n'a pas été reçu.",
            "error"
        );
    ...
    function executeAssessment(){
        ...
        if(!SecurityAssessment){
            ...
            setStatus(
                "Le moteur d'évaluation de sécurité " +
                "est indisponible.",
                "error"
            );
        ...
        if(
            typeof SecurityAssessment.assessLastAnalysis !==
            "function"
        ){

            setStatus(
                "L'action d'évaluation n'est pas disponible.",
                "error"
            );
        ...
        if(!result){
            ...
            setStatus(
                "L'évaluation n'a pas pu être exécutée. " +
                "L'analyse précédente doit être validée.",
                "error"
            );
        ...
        setStatus(
            "L'évaluation a été exécutée mais son état " +
            "de validation attendu n'a pas été reçu.",
            "error"
        );
    ...
    // ========================================================
    // APPEL DE L'ACTION : INSPECTION
    // ========================================================

    function executeInspection(){

        if(!ConfigurationInspection){

            setStatus(
                "Le moteur d'inspection de configuration " +
                "est indisponible.",
                "error"
            );
        ...
        if(
            typeof ConfigurationInspection
                .inspectLastAssessment !==
            "function"
        ){

            setStatus(
                "L'action d'inspection n'est pas disponible.",
                "error"
            );
        ...
        if(!result){
            ...
            setStatus(
                "L'inspection n'a pas pu être exécutée. " +
                "L'évaluation précédente doit être validée.",
                "error"
            );
        ...
        setStatus(
            "L'inspection a été exécutée mais son état " +
            "de validation attendu n'a pas été reçu.",
            "error"
        );
    ...
    // ========================================================
    // APPEL DE L'ACTION : DURCISSEMENT
    // ========================================================

    function executeHardening(){

        if(!ConfigurationHardening){

            setStatus(
                "Le moteur de durcissement de configuration " +
                "est indisponible.",
                "error"
            );
        ...
        if(
            typeof ConfigurationHardening
                .hardenLastInspection !==
            "function"
        ){

            setStatus(
                "L'action de durcissement n'est pas disponible.",
                "error"
            );
        ...
        if(!result){
            ...
            setStatus(
                "Le durcissement n'a pas pu être exécuté. " +
                "L'inspection précédente doit être validée.",
                "error"
            );
        ...
        setStatus(
            "Le durcissement a été exécuté mais son état " +
            "de validation attendu n'a pas été reçu.",
            "error"
        );
    ...
    // ========================================================
    // APPEL DE L'ACTION : VERIFICATION
    // ========================================================
    ...
    function executeVerification(){
        ...
        if(!HardeningVerification){
            ...
            setStatus(
                "Le moteur de vérification du durcissement " +
                "est indisponible.",
                "error"
            );
        ...
        if(
            ...
            setStatus(
                "L'action de vérification n'est pas disponible.",
                "error"
            );
        ...
        if(!result){
            ...
            setStatus(
                ...
                "Le durcissement précédent doit être validé.",
                "error"
            );
        ...
        // ----------------------------------------------------
        // LA VERIFICATION DOIT ETRE REELLEMENT REUSSIE
        // ----------------------------------------------------
        ...
        if(!verified){
            ...
            setStatus(
                "Le durcissement n'est pas vérifié. " +
                "La mission reste bloquée jusqu'à obtention " +
        ...
        setStatus(
            "La vérification est positive mais l'état " +
            "de validation attendu n'a pas été reçu.",
            "error"
        );
    ...
    // ========================================================
    // APPEL DE L'ACTION : FIN DE MISSION
    // ========================================================
    ...
    function executeCompletion(){
        ...
        if(!MissionCompletion){
            ...
            setStatus(
                "Le moteur de finalisation de mission " +
                "est indisponible.",
                "error"
            );
        ...
        if(
            typeof MissionCompletion.completeMission !==
            "function"
        ){

            setStatus(
                "L'action de finalisation n'est pas disponible.",
                "error"
            );
        ...
        if(!result){
            ...
            setStatus(
                "La mission ne peut pas être terminée. " +
                "La vérification finale doit être réussie.",
                "error"
            );
        ...
        if(
            ...
            setStatus(
                "Mission Wi-Fi terminée avec succès. " +
                "Toutes les étapes du laboratoire ont été validées.",
                "success"
            );
        ...
        setStatus(
            "La finalisation a été exécutée mais l'état " +
            "de mission attendu n'a pas été reçu.",
            "error"
        );
    ...
    // ========================================================
    // EXECUTION GENERALE D'UNE ACTION
    // ========================================================
    ...
    function executeStage(
        ...
        if(
            ...
            setStatus(
                "Cette action est verrouillée. " +
                "Vous devez respecter l'ordre pédagogique " +
                "de la mission.",
                "warning"
            );
        ...
        if(!state.selectedTarget){
            ...
            setStatus(
                "Aucune cible Wi-Fi n'est sélectionnée.",
                "error"
            );
        ...
        try{
            ...
            setStatus(
                "Une erreur contrôlée est survenue pendant " +
    ...
    function selectTarget(
        ...
        if(!target){
            ...
            setStatus(
                "La cible sélectionnée est invalide.",
                "error"
            );
        ...
        if(!TargetSelection){
            ...
            setStatus(
                "Le moteur de sélection Wi-Fi est indisponible.",
                "error"
            );
        ...
        if(!selectionId){
            ...
            setStatus(
                "Impossible d'identifier la cible Wi-Fi virtuelle.",
                "error"
            );
        ...
        try{
            ...
            if(
                typeof TargetSelection.recordSelection ===
                "function"
            ){

                result =
                    TargetSelection.recordSelection(
                        selectionId
                    );

            }
            else if(
                typeof TargetSelection.selectTarget ===
                "function"
            ){
            ...
            console.error(
                "[FOBAS WiFi Practical Interface] " +
                "Erreur lors de la sélection de la cible.",
                error
            );
        }
        ...
        setStatus(
            "Cible sélectionnée avec succès. " +
            "Vous pouvez maintenant lancer l'analyse virtuelle.",
            "success"
        );
    ...
    // ========================================================
    // AFFICHAGE DU RAPPORT D'UNE ACTION
    // ========================================================
    ...
    function renderReport(
        ...
        const stateLine =
            createElement(
                "div",
                "fobas-wifi-report-state",
                result.resultState ||
                "État non spécifié"
            );


        state.reportPanel.appendChild(
            title
        );
        ...
        const fields = [
            ...
            ["resultingEncryption", "Chiffrement final"],

            ["resultingWPSStatus", "État WPS"],
            ...
            ["residualRiskLevel", "Risque résiduel"],

            ["verificationStatus", "État de vérification"],

            ["verificationCode", "Code de vérification"],

            ["completionStatus", "État de la mission"]
        ];
    ...
    // ========================================================
    // GESTION DU CLIC SUR LES CARTES RESEAUX
    // ========================================================

    function attachNetworkSelection(){
            ...
            function(element){
                ...
                element.addEventListener(
                    ...
                    function(event){
                        ...
                        // -------------------------------------
                        // NE PAS INTERCEPTER UN BOUTON INTERNE
                        // -------------------------------------
    ...
    // ========================================================
    // DELEGATION DES BOUTONS D'ACTION
    // ========================================================
    ...
    function attachActionEvents(){
        ...
        state.actionsPanel.addEventListener(
            "click",
            function(event){
    ...
    // ========================================================
    // OBSERVATION DES NOUVEAUX RESEAUX
    // ========================================================

    function observeNetworkList(){
    ...
    function initialize(){
        ...
        console.log(
            "[FOBAS WiFi Practical Interface] " +
            "Interface pratique initialisée.",
            {
                simulationId:
                    SIMULATION_ID,
    ...
    window.FOBASWiFiPracticalInterface =
        API;
    ...
    window.FOBAS.wifi.practicalInterface =
        API;
