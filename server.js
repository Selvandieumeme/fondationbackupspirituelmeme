...
function buildEnvMappings() {
  const schools = ['FOBAS', 'LUMIERE', 'CEFOTECH', 'EPFOBAS']; // 🆕 ajoute Ecole Professionnelle FOBAS
...
function findSchoolByPassword(pw) {
  ...
  if (ENV_MAP.legacySchoolPassword && ENV_MAP.legacySchoolPassword === pass) {
    const prefer = ['FOBAS','LUMIERE','CEFOTECH','EPFOBAS'];
...
// Stats route (pou Ecole Professionnelle)
