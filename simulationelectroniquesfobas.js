...
/* ============================================================
   BOUTONS AJOUTER — BIBLIOTHÈQUE DYNAMIQUE
   ------------------------------------------------------------
   Un seul gestionnaire pour toutes les cartes générées.
   Fonctionne même après une nouvelle recherche ou catégorie.
============================================================= */

const componentLibraryGrid =
    $("componentLibraryGrid");

if (componentLibraryGrid) {

    componentLibraryGrid.addEventListener(
        "click",
        event => {
            ...
            if (component) {
                ...
                toast(
                    `Impossible d'ajouter le composant : ${componentType}`,
                    "error"
                );
            }
        }
